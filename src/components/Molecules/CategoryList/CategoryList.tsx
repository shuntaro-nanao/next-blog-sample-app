    ...
    <div>
      <ul>
        {categories.map((category, index) => (
          <li key={index} className={categoryListStyles.list}>
            <a
              href="#"
            ...
            {(category === categoryState) ? (
              <a className={categoryListStyles.link} onClick={(event) => clearPosts(event)}>
                <svg className={categoryListStyles.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
